...
На момент **19.09.2025** бот поддерживает **JP / SEA / RU** сервера.
...
# Также настройки теперь доступны через GUI!
- **Нужно ткнуть по шестерне в левом нижнем углу** 
...
В комплекте идут 4 базовых профиля:
...
4. **Auction** 💰 — откроет аукцион и протыкает везде "Перевыставить"
